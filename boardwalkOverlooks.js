...
export default {
  ...
  // ==========================================================
  // COLLISION — thin blockers right at each railing, so the player
  // can walk all the way up to the edge but not past it. Uses the
  // existing collision.js public API only; collision.js itself is
  // untouched.
  // ==========================================================
  _registerColliders() {

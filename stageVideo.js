...
// - Elevator interaction is completely separate.
//
// INTERACTION RULE:
// If the player is inside the Records HQ elevator zone,
// the elevator owns the E interaction.
// The Music + Video station does NOT respond to E there.
...
function elevatorOwnsInteraction() {
  return (
...
function buildDOM() {
  ...
  promptEl.style.border =
    "1px solid rgba(255,0,170,0.4)";

  promptEl.style.borderRadius =
    "12px";
  ...
  promptEl.style.fontWeight =
    "600";

  promptEl.style.textAlign =
    "center";

  promptEl.style.zIndex =
    "250";

  promptEl.style.cursor =
    "pointer";

  promptEl.style.pointerEvents =
    "auto";
  ...
  videoWrap.style.paddingBottom =
    "56.25%";

  videoWrap.style.background =
    "#000";

  videoWrap.style.borderRadius =
    "8px";
  ...
  modalIframe.style.position =
    "absolute";

  modalIframe.style.top =
    "0";

  modalIframe.style.left =
    "0";

  modalIframe.style.width =
    "100%";

  modalIframe.style.height =
    "100%";

  modalIframe.style.border =
    "0";
  ...
  window.addEventListener(
    ...
    e => {
      ...
      // --------------------------------------------------------
      //
      // Elevator gets priority.
      //
      // If the player is standing at the elevator, this system
...
function openModal() {
  ...
  // Never open the video from the elevator interaction zone.
  if (elevatorOwnsInteraction()) {
    return;
  }
...
export default {
  ...
  update(delta, context) {
    ...
    // ----------------------------------------------------------
    //
    // The elevator occupies a smaller, more specific interaction
    // zone inside the larger HQ video zone.
    //
    // Therefore the video prompt disappears whenever the
    // elevator owns the interaction.
